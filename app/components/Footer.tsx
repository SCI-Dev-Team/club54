...
import { useSiteLanguage } from '@/app/lib/useSiteLanguage';
import { FOOTER_COPY } from '@/app/lib/footerCopy';
    ...
    <footer className="bg-black text-white">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/events" className="text-white/60 transition-colors hover:text-red">
                  {t.linkEventHosting}
                </Link>
              </li>
              <li>
                <Link href="/community" className="text-white/60 transition-colors hover:text-red">
                  {t.linkCommunityEvents}
                </Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="mt-4 flex gap-4">
              <a href="#" className="text-white/60 transition-colors hover:text-red" aria-label="Facebook">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                </svg>
              </a>
              <a href="#" className="text-white/60 transition-colors hover:text-red" aria-label="Instagram">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
              ...
              <a href="#" className="text-white/60 transition-colors hover:text-red" aria-label="X (Twitter)">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
        ...
        <div className="mt-8 border-t border-white/10 pt-8 text-center text-sm text-white/60">
          <p>
            &copy; {year} Club54. {t.rightsSuffix}
          </p>
        </div>
      </div>
    </footer>
