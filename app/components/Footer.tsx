      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <h3 className="text-2xl font-bold text-red mb-4 uppercase tracking-wider">
              CLUB54
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/contact" className="text-gray-400 hover:text-red transition-colors">
                  Contact
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400 text-sm">
          <p>&copy; {new Date().getFullYear()} Club54. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
