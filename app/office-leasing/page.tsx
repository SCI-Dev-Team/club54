        ...
        <section className="relative bg-gradient-to-br from-red to-plum py-20 text-white">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-3xl">
              <h1 className="mb-6 text-5xl font-bold tracking-wide md:text-6xl">Space partnerships</h1>
              <p className="text-xl leading-relaxed text-gray-100">
                Club54 contemplates durable space arrangements that keep youth programming, mentorship, and café
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
              <div className="rounded-xl border border-black/10 bg-biscuit p-8 shadow-sm">
                ...
                <h2 className="mb-3 text-xl font-bold text-black">Values-first alignment</h2>
              ...
              <div className="rounded-xl border border-black/10 bg-biscuit p-8 shadow-sm">
                ...
                <h2 className="mb-3 text-xl font-bold text-black">Integrated programming</h2>
                <p className="text-sm leading-relaxed text-gray-700">
              ...
              <div className="rounded-xl border border-black/10 bg-biscuit p-8 shadow-sm">
                ...
                <h2 className="mb-3 text-xl font-bold text-black">Confidential framework</h2>
                <p className="text-sm leading-relaxed text-gray-700">
                  The Club54 concept remains owned by the founding team. Discuss how your organization can engage without
        ...
        <section className="border-t border-black/10 bg-white py-20">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div className="mb-12 text-center">
              <h2 className="mb-4 text-4xl font-bold tracking-wide text-black">Partnership inquiry</h2>
