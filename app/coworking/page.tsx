      ...
      <main>
        <section className="relative bg-gradient-to-br from-teal to-green py-20 text-white">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-3xl">
              <h1 className="mb-6 text-5xl font-bold uppercase tracking-wide md:text-6xl">Collaborative workspace</h1>
              <p className="text-xl leading-relaxed text-gray-100">
                Club 54 combines a community café with collaborative workspace and youth learning so professionals,
        ...
        <section className="bg-white py-20">
          <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
            <div className="rounded-xl border border-black/10 p-8 shadow-sm">
              ...
              <h2 className="mb-4 text-2xl font-bold uppercase tracking-wide text-black">Purpose in the space</h2>
            ...
            <div className="rounded-xl border border-black/10 p-8 shadow-sm">
              ...
              <h2 className="mb-4 text-2xl font-bold uppercase tracking-wide text-black">Coffee culture & rhythm</h2>
              <p className="leading-relaxed text-black/80">
        ...
        <section className="border-t border-black/10 bg-gradient-to-br from-biscuit/30 to-white py-20">
          <div className="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
            <h2 className="mb-4 text-3xl font-bold uppercase tracking-wide text-black">Next steps</h2>
